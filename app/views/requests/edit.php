        ...
        <form method="POST" action="<?php echo BASE_URL; ?>/public/index.php?page=requests&action=edit&id=<?php echo $request['id']; ?>">
            ...
            <div class="mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <?php if ($request['status'] !== $_POST['status'] ?? $request['status']): ?>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Nota de Cambio de Estado</label>
                        <textarea name="status_notes" rows="2"
